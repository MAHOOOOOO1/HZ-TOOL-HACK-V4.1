...
print(banner())
scanningAnimation("[+] Araç Başlatılıyor Lütfen Bekleyiniz...")
clear()
print(banner())
...
if os.path.exists(merge+bilgiler):
    ...
    print("""
    --------------------------------  UYARI  --------------------------------
     (uyarıya geçmeden yapımcı sahibi.HZ.MAHO discord:hz.maho.) Lütfen bilgileri gönderecek GMAİL hesabınızda 2 faktörlü doğrulamayı açın.
